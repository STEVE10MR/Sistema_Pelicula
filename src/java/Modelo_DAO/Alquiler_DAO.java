...
public class Alquiler_DAO {
    public int Registrar(Alquiler alquiler)
    {
        ...
        try{
            ...
            ps.setDate(1,alquiler.getFecha_Inicio());
            ps.setDate(2,alquiler.getFecha_Fin());
            ps.setDouble(3,alquiler.getValor());
            ps.setInt(4,alquiler.getCliente().getID_Cliente());
            ps.setInt(5,alquiler.getPelicula().getID());
            ps=con.prepareStatement(sql);
