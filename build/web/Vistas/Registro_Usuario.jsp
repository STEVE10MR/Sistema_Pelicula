...
<html>
    ...
    <body class="form">
        <form action="Controlador_C" method="Post" style="width: 500px; height: 400px" class="mostrar-form-r">
            ...
            <div class="contenedor-r">
                ...
                <div class="input-contenedor-l">
                    ...
                    <input type="email" name="txtcorreo"   placeholder="Ingrese su Correo" maxlength="25"/>
                </div>
                <div class="input-contenedor-l">
