<%-- 
    Document   : Clasificacion_Registrar
    Created on : Dec 3, 2021, 12:04:39 AM
    Author     : USUARIO
--%>
    ...
    <body>
        ...
        <div class="configuracion-mostrar-registrar">
            <form action="" method="Post" style="">
                <h1 class="configuracion-titulo">Registro de Clasificacion</h1>
                    <div class="contenedor-r">
                        <div class="input-contenedor-r">
                            <i class="fas fa-user icon"></i>
                            <input type="text" name="txtnombre"   placeholder="Ingresar Nombre" maxlength="25"/>
                        </div>
                    </div>
