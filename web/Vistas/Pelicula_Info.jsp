...
<html>
    ...
    <body>
		...
		<nav>
                    ...
                    <a href="Controlador_C?accion=configuracion" class="user-name">Steve</a>
                </nav>
            </div>
	</header>
        <main>
            <div class="contenedor_info">
                ...
                <div class="contenedor_tl">
                    ...
                    <br>
                    <h4 class="valor_info">S/. <%=request.getAttribute("Valor")%></h4>
                    <br>
                    <div class="contenedor_button">
                        <button role="button" class="boton_is"><i class="fas fa-shopping-cart icon"></i>Alquilar</button>
